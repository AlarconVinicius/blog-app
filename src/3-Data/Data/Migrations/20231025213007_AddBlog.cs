...
namespace Data.Migrations
{
    ...
    public partial class AddBlog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserBlogEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserBlogEntity", x => new { x.BlogsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserBlogEntity_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserBlogEntity_blogs_BlogsId",
                        column: x => x.BlogsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserBlogEntity_UsersId",
                table: "ApplicationUserBlogEntity",
                column: "UsersId");
